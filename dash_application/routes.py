...
from dash_application.functions import *
...
@app.server.route('/make_prediction', methods=['GET', 'POST'])
def prediction_form():
   return render_template('prediction_form.html')
   
@app.server.route('/heatmap', methods=['GET', 'POST'])
def heatmap():
   return render_template('heatmap.html')

@app.server.route('/visualizations')
def visualization():
   return render_template('visualizations.html')

@app.server.route('/report_crime_form')
def report_crime():
...
@app.server.route('/reported_crimes')
...
@app.server.route('/delete/<int:id>')
def erase(id):
